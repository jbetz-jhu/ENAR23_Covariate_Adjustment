...
load(
  url(
    paste0("https://github.com/jbetz-jhu/ENAR23_Covariate_Adjustment/raw/",
...
## Installing R Packages from GitHub {.columns-2 .smaller}
  ...
  - "Base R" comes with set of packages: Expanded to extend capabilities
...
## Adjusted Cox PH Model {.columns-2 .smaller}
